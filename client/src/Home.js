      ...
      <section className="py-12 px-4">
        <div className="max-w-2xl mx-auto text-center text-accent">
          ...
          <p className="text-lg mb-8">
            Additionally, our Explore page allows you to discover sunrise and sunset data for national parks. Add your favorite parks to your personal collection for at-a-glance reference, and plan your next adventure to witness unforgettable sunrises and sunsets in these breathtaking natural landscapes.
          </p>
