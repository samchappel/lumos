...
locations_list = [
    ...
    {"name": "Arches National Park", "latitude": 38.7331, "longitude": -109.5925, "timezone": "MST", "city": "Moab", "state": "Utah", "image": "https://github.com/samchappel/lumos/blob/main/client/public/arches.jpeg?raw=true", "park_type": "National Park"},
    ...
    {"name": "Big Bend National Park", "latitude": 29.1275, "longitude": -103.2425, "timezone": "CST", "city": "Alpine", "state": "Texas", "image": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTqJtY5jO8_I5EaREB1FgGzjqyUqYtr9dTBd0a5kjCfX7oWeahrqDNXUKfJpZeDdQmM_vU&usqp=CAU", "park_type": "National Park"},
    ...
    {"name": "Capitol Reef National Park", "latitude": 38.3670, "longitude": -111.2615, "timezone": "MST", "city": "Torrey", "state": "Utah", "image": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWWAOQL6IQlM4bbSY-KSGOncgOyzX40ARdoA&usqp=CAU", "park_type": "National Park"},
    ...
    {"name": "Denali National Park and Preserve", "latitude": 63.3333, "longitude": -150.5000, "timezone": "AKST", "city": "Healy", "state": "Alaska", "image": "https://github.com/samchappel/lumos/blob/main/client/public/denali.jpeg?raw=true", "park_type": "National Park"},
    {"name": "Dry Tortugas National Park", "latitude": 24.6285, "longitude": -82.8732, "timezone": "EST", "city": "Key West", "state": "Florida", "image": "https://github.com/samchappel/lumos/blob/main/client/public/dry%20tortugas.jpeg?raw=true", "park_type": "National Park"},
    ...
    {"name": "Gateway Arch National Park", "latitude": 38.6247, "longitude": -90.1848, "timezone": "CST", "city": "St. Louis", "state": "Missouri", "image": "https://github.com/samchappel/lumos/blob/main/client/public/gateway%20arch.jpeg?raw=true", "park_type": "National Park"},
    {"name": "Glacier National Park", "latitude": 48.7596, "longitude": -113.7870, "timezone": "MST", "city": "West Glacier", "state": "Montana", "image": "https://github.com/samchappel/lumos/blob/main/client/public/glacier.jpeg?raw=true", "park_type": "National Park"},
    ...
    {"name": "Great Sand Dunes National Park and Preserve", "latitude": 37.7916, "longitude": -105.5943, "timezone": "MST", "city": "Mosca", "state": "Colorado", "image": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQMTy2eoqidOIyS5X0FsZ62t-inAUwP0NeZog&usqp=CAU", "park_type": "National Park"},
    ...
    {"name": "Kobuk Valley National Park", "latitude": 67.5500, "longitude": -159.2833, "timezone": "AKST", "city": "Kotzebue", "state": "Alaska", "image": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSZOjvvH4ztRPSP1zA9pmfiSmvJfuRjk6OcRw&usqp=CAU", "park_type": "National Park"},
    ...
    {"name": "Voyageurs National Park", "latitude": 48.5098, "longitude": -92.8893, "timezone": "CST", "city": "International Falls", "state": "Minnesota", "image": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSanTkcOfWpgvSshgl-G-UGiNnyDh6oD1Rq5Q&usqp=CAU", "park_type": "National Park"},
...
photos_list = [
    ...
    {"user_id": 3, "image": "./uploads/7.jpg", "location": "Top of the World", "city": "Laguna Beach", "state": "California", "caption": "See the world through film on my Instagram! (@filmpotato_)", "date": "2017-09-16"},
    {"user_id": 3, "image": "./uploads/8.jpg", "location": "On the Pier", "city": "Santa Barbara", "state": "California", "caption": "Discover the beauty of film photography on Instagram! (@filmpotato_)", "date": "2017-09-16"},
    {"user_id": 3, "image": "./uploads/9.jpg", "location": "Morning Froth", "city": "Fire Island", "state": "New York", "caption": "Explore my film photography journey on Instagram! (@filmpotato_)", "date": "2017-09-16"},
    {"user_id": 3, "image": "./uploads/10.jpg", "location": "That One Place", "city": "Santa Cruz", "state": "California", "caption": "Join me on Instagram for more film photography! (@filmpotato_)", "date": "2017-09-16"},
    {"user_id": 3, "image": "./uploads/11.jpg", "location": "Eastern Sieera Nevada Mountains", "city": "Mammoth Lakes", "state": "California", "caption": "Experience the beauty of film photography on Instagram! (@filmpotato_)", "date": "2017-09-16"},
    {"user_id": 3, "image": "./uploads/12.jpg", "location": "My Back Deck", "city": "Santa Cruz", "state": "California", "caption": "Discover the world of film photography on Instagram! (@filmpotato_)", "date": "2017-09-16"},
    {"user_id": 3, "image": "./uploads/13.JPG", "location": "Steamer Lane", "city": "Santa Cruz", "state": "California", "caption": "Check out my film photos on Instagram! (@filmpotato_)", "date": "2017-09-16"},
    {"user_id": 3, "image": "./uploads/14.JPG", "location": "Midnight Safari", "city": "Silver City", "state": "New Mexico", "caption": "Join me on Instagram for more film photography! (@filmpotato_)", "date": "2017-09-16"},
    {"user_id": 3, "image": "./uploads/15.jpg", "location": "Natural Bridges State Beach", "city": "Santa Cruz", "state": "California", "caption": "Discover the art of film photography on Instagram! (@filmpotato_)", "date": "2017-09-16"},
    {"user_id": 3, "image": "./uploads/16.jpg", "location": "West Cliff Drive", "city": "Santa Cruz", "state": "California", "caption": "Follow my film photography journey on Instagram! (@filmpotato_)", "date": "2017-09-16"},
    {"user_id": 3, "image": "./uploads/17.jpg", "location": "West Cliff Drive", "city": "Santa Cruz", "state": "California", "caption": "Explore the world of film photography on Instagram! (@filmpotato_)", "date": "2017-09-16"},
    {"user_id": 3, "image": "./uploads/18.jpg", "location": "West Cliff Drive", "city": "Santa Cruz", "state": "California", "caption": "Join me on Instagram for more film photography! (@filmpotato_)", "date": "2017-09-16"},
    {"user_id": 3, "image": "./uploads/19.jpg", "location": "Young Pueblo", "city": "Pueblo", "state": "Colorado", "caption": "Discover the beauty of film photography on Instagram! (@filmpotato_)", "date": "2017-09-16"},
